...
function buildUnifiedRecords(uData, fData, pData) {
    // FIX: Fallback to raw arrays if 'symbols', 'stocks', or 'quotes' keys are missing
    ...
    var resolved = symbols.filter(function(s) {
        // FIX: Check both 'ticker' and 'symbol' keys to prevent blank records
        ...
        // Ensure the ticker is standardized as 'ticker' for the mapping below
