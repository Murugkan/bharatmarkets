...
def setup_logging():
    """Initialize comprehensive logging - all to data_processing.log"""
    Path('logs').mkdir(exist_ok=True)
    
    main_logger = logging.getLogger('market_data')
    main_logger.setLevel(logging.DEBUG)
    
    # File handler - all logs to data_processing.log (DEBUG level)
    fh = logging.FileHandler('logs/data_processing.log', mode='w')
...
def main():
    ...
    print("   ✓ logs/data_processing.log (all events + rejections)")
    print()
