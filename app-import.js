...
function renderStep2() {
    return '<div style="padding:20px;background:#0a0a0a;border:1px solid #111;border-radius:8px;">' +
        ...
        '<p style="margin:10px 0;color:#888;font-size:12px;">' +
        'Format: <b>Stock Name, Symbol, [QTY], [AVG]</b><br>' +
        'One per line. QTY and AVG optional.<br>' +
...
function renderStep3() {
    ...
    var prompt = 'I have these Indian stocks (NSE/BSE). Get ISIN, sector, and industry for each.\n' +
        ...
        '...\n\n' +
        'Skip if stock is international or not found.';
    
    return '<div style="padding:20px;background:#0a0a0a;border:1px solid #111;border-radius:8px;">' +
        '<h3 style="margin:0 0 10px 0;color:#00ff88;font-size:14px;">Generate AI Prompt</h3>' +
        '<p style="margin:10px 0;color:#888;font-size:12px;">' +
        'Copy the prompt below and paste into ChatGPT or Claude to get ISIN, sector, and industry data.' +
        '</p>' +
        ...
        '⚠️ After getting response from AI, paste it in Step 4' +
        '</div>' +
        '</div>';
}
...
function renderStep4() {
    return '<div style="padding:20px;background:#0a0a0a;border:1px solid #111;border-radius:8px;">' +
        ...
        '<p style="margin:10px 0;color:#888;font-size:12px;">' +
        'Paste the AI response here. Format: Symbol | ISIN | Sector | Industry' +
        '</p>' +
