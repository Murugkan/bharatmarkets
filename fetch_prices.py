...
SPECIAL_MAP = {
    ...
    "NIFTYIT":      "^CNXIT",
    "MIDCAP":       "^NSEMDCP50",
    # Company renames — NSE symbol → Yahoo Finance ticker
    "AMARAJAB":     "ARE&M.NS",
    ...
    # ── All confirmed failing symbols from portfolio ──
    ...
    "KWALYPH":       "KWALITYPHARM.NS",
    "TITANBIOTE":    "TITANBIO.NS",
    "MBENGINEERING": "MBENGINE.NS",
    "CAPITALNUMB":   "CNINFOTECH.NS",
    # BSE-only stocks
