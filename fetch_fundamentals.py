...
NSE_TO_YAHOO = {
    ...
    "AZADINDIA":     "AZAD",        # Azad Engineering Ltd
    "AMARAJAB":      "ARE&M",       # Amara Raja Energy & Mobility
    "AMARAJABAT":    "ARE&M",       # same company, new NSE ticker
    ...
    "M&M":           "M%26M",
    "M&MFIN":        "M%26MFIN",
    # ── Portfolio stocks confirmed from CDSL file ──
    # These are the correct NSE→Yahoo mappings for all 92 portfolio stocks
    "ACMESOLAR":     "ACMESOLAR",
    "AFCONS":        "AFCONS",
    "ABCAPITAL":     "ABCAPITAL",
    "ABFRL":         "ABFRL",
    ...
    "CAPITALNUMB":   "CNINFOTECH",   # CapitalNumbers — Yahoo uses CNINFOTECH
    "CAPITALNUMBERS":"CNINFOTECH",
    "CELLOWORLD":    "CELLOWORLD",
    "CDSL":          "CDSL",
    "CIGNITI":       "CIGNITI",
    ...
    "HDFCBANK":      "HDFCBANK",
    "HDFCLIFE":      "HDFCLIFE",
    "HIGHENERGYB":   "HIGHENERGYB",
    "HINDRECTIF":    "HINDRECTIF",
    "HAL":           "HAL",
    ...
    "INDIANB":       "INDIANB",
    "IOC":           "IOC",
    "INDOTECHTR":    "INDOTECHTR",
    "JYOTHYLAB":     "JYOTHYLAB",
    "KPENERGI":      "KPENERGI",
    "KAYNES":        "KAYNES",
    "KEI":           "KEI",
    "KWALITYPHARM":  "KWALITYPHARM",
    "MBENGINEERING": "MBENGINEERING",
    ...
    "REDTAPE":       "REDTAPE",
    "REVATHI":       "REVATHI",
    "ROSSELLTECH":   "ROSSELLTECH",
    "RAIN":          "RAIN",
    "RATEGAIN":      "RATEGAIN",
    "REPCOHOME":     "REPCOHOME",
    "SSPOWERSWIT":   "SSPOWERSWIT",
    "SAGILITY":      "SAGILITY",
    "SHREEREFRI":    "SHREEREFRI",
    "SKMEPEX":       "SKMEPEX",
    "SUZLON":        "SUZLON",
    "SANDUMA":       "SANDUMA",
    "SHILCTECH":     "SHILCTECH",
    "SIKAINTERP":    "SIKAINTERP",
    "SBIN":          "SBIN",
    "SUNFLAG":       "SUNFLAG",
    "SUPRIYA":       "SUPRIYA",
    "SUYOGTELE":     "SUYOGTELE",
    ...
    "ZINKA":         "ZINKA",
    "ZENTECH":       "ZENTECH",
    # ── All 20 confirmed failing symbols — correct Yahoo tickers ──
    "SHILCHAR":      "SHILCTECH",   # NSE: SHILCTECH not SHILCHAR
    "SHILCTECH":     "SHILCTECH",
    "GRAUERWEIL":    "GRAUWEIL",    # NSE: GRAUWEIL not GRAUERWEIL
    "HBLPOWER":      "HBLENGINE",   # Renamed to HBL Engineering → HBLENGINE
    "AZADINDIA":     "AZAD",        # NSE: AZAD not AZADINDIA
    "BLACKBOXLIMI":  "BBOX",        # Black Box → BBOX
    "KWALYPH":       "KWALITYPHARM",
    "TITANBIOTE":    "TITANBIO",    # Titan Biotech → TITANBIO
    "MBENGINEERING": "MBENGINE",    # M&B Engineering → MBENGINE
    # BSE-only stocks — force .BO suffix (no .NS on Yahoo)
    "HIGHENERGYB":   "HIGHENERGYB.BO",
    "SIKAINTERP":    "SIKAINTERP.BO",
    "KPENERGI":      "KPENERGI.BO",
    "SUYOGTELE":     "SUYOGTELE.BO",
    "INDOTECHTR":    "INDOTECHTR.BO",
    "ROSSELLTECH":   "ROSSELLTECH.BO",
    "SSPOWERSWIT":   "SSPOWERSWIT.BO",
    "REVATHI":       "REVATHI.BO",
    "SKMEPEX":       "SKMEPEX.BO",
    "SHREEREFRI":    "SHREEREFRI.BO",
    "HINDRECTIF":    "HINDRECTIF.BO",
    "VIKRAMSOLAR":   "VIKRAMSOLAR.BO",
    # ── Additional portfolio stocks confirmed failing ──
    "GRAUERWEIL":    "GRAUERWEIL",
    "INDIANBRIGHT":  "INDIAMART",    # Indian Bright Steel
    "TRUALTBIO":     "TRUALTBIO",
    "VENTIVE":       "VENTIVE",
    "ROSSELLTECH":   "ROSSELLTECH",
    "SSPOWERSWIT":   "SSPOWERSWIT",
    ...
    "MBENGINEERING": "MBENGINEERING",
    "IDEAFORGE":     "IDEAFORGE",
    "CAPITALNUMB":   "CNINFOTECH",   # CapitalNumbers — Yahoo: CNINFOTECH
    # ── Common alternate spellings ──
    "PVRL":          "PVRINOX",
    "PVR":           "PVRINOX",
    "CIGNITITECH":   "CIGNITI",
    "DATAMATICSGL":  "DATAMATICS",
    "ROSSELL":       "ROSSELLTECH",
}
...
def resolve_yf_sym(nse_sym):
    ...
    Handles .NS, .BO, ^ prefixes and bare symbols correctly.
    """
    ...
    if nse_sym in NSE_TO_YAHOO:
        ...
        # If already has exchange suffix (.NS/.BO) or is an index (^), use as-is
        result = v if ("." in v or v.startswith("^")) else v + ".NS"
        YF_ALIAS_CACHE[nse_sym] = result
        return result
    return nse_sym + ".NS"

def yahoo_search_sym(nse_sym):
    """
    Search Yahoo Finance API to find correct ticker when standard .NS fails.
    Tries multiple search strategies:
    1. Direct search by NSE symbol
    2. Search with "NSE" appended
    3. Check if a shorter version of the symbol works
    """
    if not HAS_BS4:
        return None
    ...
    for q_str in queries:
        try:
            ...
            for q in quotes:
                ...
                # Only NSE equity quotes
                if sym_yf.endswith(".NS") and qtype in ("EQUITY", ""):
                    print(f"  🔍 {nse_sym} → {sym_yf} (via search)")
                    YF_ALIAS_CACHE[nse_sym] = sym_yf
                    NSE_TO_YAHOO[nse_sym] = sym_yf.replace(".NS", "")
                    return sym_yf
...
def load_symbols():
    """
    Read portfolio_symbols.txt first (actual portfolio stocks).
    Fall back to watchlist.txt for any extras.
    Deduplicated, skip index symbols.
    """
    syms = []
    seen = set()
...
def fetch_yfinance(sym):
    ...
    try:
        ...
        if hist_short is None or hist_short.empty:
            ...
            found_sym = yahoo_search_sym(sym)
            if found_sym:
                yf_sym = found_sym
                t = yf.Ticker(yf_sym)
                try:
